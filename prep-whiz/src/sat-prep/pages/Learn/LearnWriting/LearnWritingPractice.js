...
const LearnWritingPractice = (props) => {
    ...
    const [isNextClickPending,setIsNextClickPending]=useState(false)
    ...
    useEffect(()=>{
        ...
        const getQuestionQILessonLIWithName=async()=>{
            try{
              ...
              console.log("response from use effect", jsonResponse);
    ...
    if (!lessonDetails && !questionDetails || isLoading){
        //QUESTION OR ERROR MESSAGE HASN'T LOADED IN YET
        return <Loading />
    } 
    ...
    if (lessonDetails.isReviewing){
        {console.log(lessonDetails)}
        //ON QUESTION REVIEW PAGE
        return(
            <div>
                ...
                <div className="">
                    <div className="px-32 flex items-center">
                        ...
                        <div className="flex items-center">
                            <div onClick={()=>{navigate("/testprep/sat/learn/writing/video/"+lesson)}}
            ...
            <div className="bottom-0 w-screen mt-4 fixed bg-white z-20">
                ...
                <div className="px-96 flex justify-between items-center">
                    ...
                    <button onClick={()=>{handleNextQuestionClick(); setToggle(!toggle)}}
...
function getCorrectChoices(){
    ...
    <div className="flex flex-col justify-evenly w-full font-serif mb-8"> 
        {arr.map((choice,i)=>{
            if (choice === questionDetails.solution){
                return(
                    <h1
            ...
            }else if (choice === lessonDetails.selectedChoice){
                return(
                    <h1
...
export default LearnWritingPractice;
