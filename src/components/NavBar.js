...
const NavBar = () => {
  ...
  return (
    <div className={`left-0 fixed top-0 z-30 duration-300`} style={{width:"100%"}}>
      
        <div className="bg-yellow-400 border-b-8 border-yellow-600">
          {/* DESKTOP NAVBAR */}
          <div className="lg:grid hidden relative w-5/12 lg:ml-12 ml-4 grid-flow-row grid-cols-4 text-center justify-center items-center m-0 z-10">
            <img src={logo} className={`cursor-pointer h-20 rounded-full my-4 p-2 mx-auto`} onClick={()=>{window.location.reload()}}></img>
            <div className={`flex px-4 items-center w-full justify-between flex-auto text-center text-yellow-600 font-sans 
                            whitespace-nowrap lg:text-2xl md:text-xl duration-300 font-extrabold scale-y-110 col-span-3`} style={{fontFamily: "'Nunito', sans-serif"}}>
              <a href="/#top" className="px-4 hover:text-yellow-1 hover:scale-110 duration-200">
                Home
              </a>
              <a href="/#about" className="px-4 hover:text-yellow-1 hover:scale-110 duration-200">
                About
              </a>
              <a href="/#events" className="px-4 hover:text-yellow-1 hover:scale-110 duration-200">
                Events
              </a>
              <a href="/#judges" className="px-4 hover:text-yellow-1 hover:scale-110 duration-200">
                Judges
              </a>
              <a href="/#sponsors" className="px-4 hover:text-yellow-1 hover:scale-110 duration-200">
                Sponsors
              </a>
          ...
          {/* MOBILE NAVBAR */}
          <div className="lg:hidden grid relative ml-12 py-4 z-10">
            ...
            <div className={`${open ? "2xl:hidden flex": "hidden"} absolute top-12 -left-6 z-20 bg-yellow-400 flex-col rounded-xl border-6 border-yellow-800` }>
                ...
                <a href="#events" className="px-9 py-2 text-yellow-800 font-bold cursor-pointer font-light-bubble text-xl">Events</a>
