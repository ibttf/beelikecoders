  ...
  return (
    ...
    <div className={`fixed top-0 w-screen ${sticky ? "bg-yellow-700" : ""}`}>
      <div className="w-10/12 mx-auto grid grid-flow-row grid-cols-12 text-center justify-center items-center py-1 ">
        ...
        <div className={`px-4 flex items-center w-full justify-between flex-auto text-center text-yellow-100 font-light-bubble 
                        whitespace-nowrap text-xl duration-300 font-extrabold`}>
          <Link to ="/" className="px-4 hover:text-yellow-50 hover:scale-110 duration-200">
            Home
          </Link>
          <Link to ="/about" className="px-4 hover:text-yellow-50 hover:scale-110 duration-200">
            About
          </Link>
          <Link to ="/schedule" className="px-4 hover:text-yellow-50 hover:scale-110 duration-200">
            Schedule
          </Link>
          <Link to ="/Judges" className="px-4 hover:text-yellow-50 hover:scale-110 duration-200">
            Judges
          </Link>
          <Link to ="/sponsors" className="px-4 hover:text-yellow-50 hover:scale-110 duration-200">
            Sponsors
          </Link>
