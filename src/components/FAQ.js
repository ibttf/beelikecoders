...
const FAQ = () => {
  ...
  const [logOpen4,setLogOpen4]=useState(false)
    return (
        <div className="w-full my-48 relative" id="faq">
        <div className="md:w-9/12 w-10/12 mx-auto bg-white  text-red-600  py-36 rounded-t-full text-left rounded-r-xl px-12 border-20 border-red-600"
             
             >
            <h1 className="font-bubble text-center text-7xl   py-12 drop-shadow-xl">
              FAQ</h1>
            <div className="lg:flex lg:items-start xl:w-9/12 mx-auto">
              {/* GENERAL QUESTIONS */}
              <div className="flex flex-col w-full mr-4">
                <h1 className="font-bubble text-4xl  py-4 drop-shadow-xl">GENERAL</h1>
                {/* WHAT IS A HACKATHON? */}
                ...
                <div className="h-full">
                  ...
                  <div className={`${genOpen7? "h-full": "h-0"} font-light-bubble ml-2 xl:text-3xl text-xl overflow-hidden pl-2 text-red-900`}>
                    ...
                    <span className="underline text-red-500"> beelikecoders@gmail.com.</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col xl:ml-16 w-full mr-4">
                <h1 className="font-bubble text-left text-4xl  py-4 drop-shadow-xl">OTHER</h1>
        ...
        <div className="w-1/12 absolute left-0 right-0 mx-auto bg-gray-400 rounded-b-xl py-24 z-0 tree" >
        </div>
